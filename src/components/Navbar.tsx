...
export default function Navbar() {
  ...
  return (
    <div className="flex justify-center sticky top-0 z-50 pb-16">
      <div
        className={
          'border-black items-center bg-gradient-to-r from-blue-700 to-indigo-800 fixed w-full shadow-2xl  flex justify-center font-montserrat py-4'
        }
      >
        <div className="flex flex-col space-y-4  items-center">
          ...
          {user ? <span className="text-white">Logged in as: {user.email}</span> : null}
        </div>
      </div>
    </div>
  )
