import { FaHtml5, FaCss3Alt, FaWpforms } from "react-icons/fa";
    ...
    <div className="flex flex-col items-center h-full rounded-xl bg-slate-300 bg-opacity-20 text-white p-10 font-montserrat pb-12 gap-14">
      ...
      <ul className=" md:grid md:grid-cols-2 flex flex-col gap-14">
        ...
        <li className="w-72">
          ...
          <strong className="text-[#fcca3f]">tsx</strong> ) to structure the
        ...
        <li className="w-72">
          ...
          <strong className="text-[#fcca3f]">Tailwind</strong> to style the
          website for making it{" "}
          <strong className="text-[#fcca3f]">responsive </strong>on both desktop
        ...
        <li className="w-72">
          ...
          <strong className="text-[#fcca3f]">NoSQL</strong>) to store retrieve
          data for the website's features such as{" "}
        ...
        <li className="w-72">
          ...
          <strong className="text-[#fcca3f]">Modularity</strong>, designing
          components as atoms, molecules, cells and organisms.{" "}
          <strong className="text-[#fcca3f]">Local namespacing</strong> (less
          modules) to group related components and variables under a single
          file.
        </li>
        ...
        <li className="w-72">
          ...
          to handle <strong className="text-[#fcca3f]">
            form inputs
          </strong>, <strong className="text-[#fcca3f]">validations</strong>
          {""} and <strong className="text-[#fcca3f]">submission</strong> for
          features such as <strong className="text-[#fcca3f]">login</strong>,{" "}
        ...
        <li className="w-72">
          <AiOutlineUser
            ...
            className="float-left mr-2 text-blue-200 mt-1"
          />
          <strong className="text-[#fcca3f]">User roles</strong>,{" "}
          <strong className="text-[#fcca3f]">user profiles</strong>,{" "}
          <strong className="text-[#fcca3f]">cookies</strong> for managing
          session length.
        </li>
        ...
        <li className="w-72">
          ...
          . Focused on{" "}
          <strong className="text-[#fcca3f]">atomic commits</strong>,
